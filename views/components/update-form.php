...
{ 
    ...
    if(count($errors) == 0)
    {
        Animal::updateAnimal($_GET["id"],$pet_name,$pet_age,$pet_gender,$pet_weight,$pet_tattooed,$pet_chiped,$pet_color,$pet_race,$pet_specie);
        $show1 = true;
    }else{
    ...
    $f_pet_name = $row["name"];
    $f_pet_age = $row["age"];
    $f_pet_gender = $row["gender"];
    $f_pet_weight = $row["weight"];
    $f_pet_tattooed = $row["tatoo"];
    $f_pet_chiped = $row["chip"];
    $f_pet_color = "";
    $f_pet_specie = "";
    $f_pet_race = "";
    }
...
<!-- Failure Toast -->
<?php if($show2 == true) { ?>
<div  id="alert-border-3" class="flex fixed items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
<svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
  <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
</svg>
<div class="ml-3 text-sm font-medium">
...
<button  id= "close-succes" type="button" class="ml-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700">
  <span class="sr-only">Dismiss</span>
  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
  </svg>
...
<div class="w-full flex min-w-full justify-center  max-w-xs">
    <form class="bg-white shadow-md  rounded px-8 pt-6 pb-8 mb-4" action="" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text"
            value="<?= htmlspecialchars($f_pet_name ?? '') ?>" name="pet-name"
        ...
        <div class="mb-4">
            ...
            <input
            value="<?= htmlspecialchars($f_pet_age ?? '') ?>"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            ...
            <input
            value="<?= htmlspecialchars($f_pet_weight ?? '') ?>"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            ...
            <label for="">Male</label><input type="radio" name="pet-gender" <?= $f_pet_gender == "Male" ? "checked" : "" ?> value="Male" id="pet-gender" class="radio">
            <label for="">Femelle</label><input type="radio" name="pet-gender" <?= $f_pet_gender == "Female" ? "checked" : "" ?> value="Female" id="pet-gender" class="radio">
        </div>
        <!-- Tattouage -->
        <div class="mb-4">
            ...
            <input type="checkbox" name="pet-tattooed" id="tatoo" <?= $f_pet_tattooed == 1 ? "checked" : "" ?>>
        </div>
        <!-- Puçage -->
        <div class="mb-4">
            ...
            <input type="checkbox" name="pet-tattooed" id="puce" <?= $f_pet_chiped == 1 ? "checked" : "" ?>>
        </div>
        <!-- Couleur -->
        <div class="mb-4">
